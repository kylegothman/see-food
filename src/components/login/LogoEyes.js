...
export default function LogoEyes() {
  ...
  return (
    <Box className="main" >
      ...
      <Box id="eyes">
        <img height='35px' width='35px' className="eye" src={logo_eyes} alt="pupil" style={{ top: 36, right: 69, transform: `rotate(${270 + angleDeg}deg)`}} />
        <img height='35px' width='35px' className="eye" src={logo_eyes} alt="pupil" style={{ top: 36, right: 39, transform: `rotate(${270 + angleDeg}deg)` }} />
      </Box>
    </Box>
  );
}